...
{
	/// <summary>
	/// Creates UI elements for a list of items. Instantiates an instance of <see cref="Item"/> for each one specified.
	/// </summary>
	public class ItemList: MonoBehaviour
	{
		...
		/// <summary>
		/// Destroys children and creates UI elements based on the <see cref="Data"/> property.
		/// </summary>
