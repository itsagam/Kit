...
namespace Kit.Pooling
{
	...
	public enum PoolMessageMode
	{
		...
		/// <summary>Call <see cref="MonoBehaviour.SendMessage(string)" /> on instance GameObjects.</summary>
		SendMessage,

		/// <summary>Call <see cref="MonoBehaviour.BroadcastMessage(string)" /> on instance GameObjects.</summary>
		BroadcastMessage
	}
