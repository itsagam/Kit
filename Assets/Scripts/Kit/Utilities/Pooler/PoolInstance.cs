...
{
	/// <summary>
	///     Component added to all instances so we can track the <see cref="Pool" /> they came from. Used in <see cref="Pooler.Destroy" />
	/// 	to de-activate instances without providing pool.
	/// </summary>
