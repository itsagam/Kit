...
namespace Kit.Containers
{
	...
	{
		/// <summary>Return a <see cref="ReactiveCollection{T}" /> of all the upgrades applied.</summary>
		ReactiveCollection<Upgrade> GetUpgrades();
	}

	/// <summary>A more inspector-friendly list for use in <see cref="Sirenix.OdinInspector.SerializedMonoBehaviour" />s.</summary>
