...
namespace Kit.Containers
{
	...
	public class BiDictionary<TFirst, TSecond>
	{
		...
		/// <summary>Find the TSecond corresponding to a TFirst.</summary>
		...
		/// <summary>Find the TFirst corresponding to a TSecond.</summary>
		...
		/// <summary>Remove the pair corresponding to a TFirst.</summary>
		/// <exception cref="ArgumentException">Throws an exception if the TFirst is not in the dictionary.</exception>
		...
		/// <summary>Remove the pair corresponding to a TSecond.</summary>
		/// <exception cref="ArgumentException">Throws an exception if the TSecond is not in the dictionary.</exception>
		...
		/// <summary>Find the TSecond corresponding to the TFirst first.</summary>
		...
		/// <summary>Find the TFirst corresponding to the TSecond second.</summary>
		...
		/// <summary>Remove the pair containing a TFirst, if there is one.</summary>
		...
		/// <summary>Remove the pair containing a TSecond, if there is one.</summary>
